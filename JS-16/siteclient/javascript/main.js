...
function ajoutFormulaire(){ // fonction permettant d'afficher l'ajouter form ou plutôt enlever la classe "d-none"
...
function afficherFormModification(position){
    ...
    document.querySelector("#identifiant").value = position;
}
